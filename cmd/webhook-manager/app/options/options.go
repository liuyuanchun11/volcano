...
const (
	...
	defaultQPS              = 50.0
	defaultBurst            = 100
	defaultEnabledAdmission = "/jobs/mutate,/jobs/validate,/podgroups/mutate,/pods/validate,/pods/mutate,/queues/mutate,/queues/validate,/hyperjobs/mutate,/hyperjobs/validate"
