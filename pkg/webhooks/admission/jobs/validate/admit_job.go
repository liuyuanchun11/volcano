...
func AdmitJobs(ar admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	...
	case admissionv1.Create:
		msg = ValidateJobCreate(job, &reviewResponse, config)
...
func ValidateJobCreate(job *v1alpha1.Job, reviewResponse *admissionv1.AdmissionResponse,
	config *router.AdmissionServiceConfig) string {
	var msg string
